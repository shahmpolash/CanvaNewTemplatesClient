...
const AdminTestimonialSection = () => {
    ...
    useEffect(() => {
        fetch(`https://canva-pro-69848a87bb3e.herokuapp.com/testimonialtext`)
            .then((res) => res.json())
            .then((info) => setTestimonialText(info));
    }, []);

    useEffect(() => {
        fetch(`https://canva-pro-69848a87bb3e.herokuapp.com/testimonials`)
            .then((res) => res.json())
    ...
    const handleTestimonialSection = (event) => {
        ...
        const url = `https://canva-pro-69848a87bb3e.herokuapp.com/add-testimonial-text`;
        fetch(url, {
            method: "POST",
            headers: {
    ...
    const handleStepSection = (event) => {
        ...
        const url = `https://canva-pro-69848a87bb3e.herokuapp.com/add-testimonial`;
        fetch(url, {
            method: "POST",
            headers: {
                "content-type": "application/json",
