...
const AddUser = () => {
    ...
    useEffect(() => {
        fetch(`https://canva-pro-69848a87bb3e.herokuapp.com/users`)
            .then((res) => res.json())
    ...
    const handleUser = (event) => {
        ...
        const url = `https://canva-pro-69848a87bb3e.herokuapp.com/add-user`;
        fetch(url, {
            method: "POST",
            headers: {
    ...
    useEffect(() => {
        const fetchAdminUsers = async () => {
            try {
                const response = await fetch(`https://canva-pro-69848a87bb3e.herokuapp.com/users`);
