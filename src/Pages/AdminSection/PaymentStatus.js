...
const PaymentStatus = () => {
    ...
    useEffect(() => {
        fetch(`https://canva-pro-69848a87bb3e.herokuapp.com/order/${id}`)
            .then((res) => res.json())
    ...
    const handlePaymentStatus = (event) => {
        ...
        const url = `https://canva-pro-69848a87bb3e.herokuapp.com/order/${order._id}`;
        fetch(url, {
            method: "PUT",
            headers: {
    ...
    const handleOrderStatus = (event) => {
        ...
        const url = `https://canva-pro-69848a87bb3e.herokuapp.com/order-for-status/${order._id}`;
        fetch(url, {
            method: "PUT",
            headers: {
                "content-type": "application/json",
