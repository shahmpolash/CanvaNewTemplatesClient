...
const PlaceOrder = () => {
  ...
  useEffect(() => {
    fetch(`https://canva-pro-69848a87bb3e.herokuapp.com/cash-on-delivery`)
      .then((res) => res.json())
  ...
  useEffect(() => {
    fetch(`https://canva-pro-69848a87bb3e.herokuapp.com/payment-accounts`)
      .then((res) => res.json())
  ...
  const handlePlaceOrder = (event) => {
    ...
    const url = `https://canva-pro-69848a87bb3e.herokuapp.com/new-order`;
    fetch(url, {
      method: "POST",
      headers: {
  ...
  const handlePlaceOrderCashOnDelivery = (event) => {
    ...
    const url = `https://canva-pro-69848a87bb3e.herokuapp.com/new-order-cash-on-delivery`;
    fetch(url, {
      method: "POST",
      headers: {
        "content-type": "application/json",
