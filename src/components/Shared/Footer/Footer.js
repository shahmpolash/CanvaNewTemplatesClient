...
const Footer = () => {
  ...
  useEffect(() => {
    fetch(`https://canva-pro-69848a87bb3e.herokuapp.com/logo`)
      .then((res) => res.json())
  ...
  useEffect(() => {
    fetch(`https://canva-pro-69848a87bb3e.herokuapp.com/categories`)
      .then((res) => res.json())
      .then((info) => setCategories(info));
  }, [categories]);

  useEffect(() => {
    fetch(`https://canva-pro-69848a87bb3e.herokuapp.com/footer-about`)
      .then((res) => res.json())
      .then((info) => setFooterAbout(info));
  }, []);

  useEffect(() => {
    fetch(`https://canva-pro-69848a87bb3e.herokuapp.com/footer-address`)
      .then((res) => res.json())
      .then((info) => setFooterAddress(info));
  }, [footerAddress]);

  useEffect(() => {
    fetch(`https://canva-pro-69848a87bb3e.herokuapp.com/footer-social`)
      .then((res) => res.json())
      .then((info) => setFooterSocial(info));
  }, []);

  useEffect(() => {
    fetch(`https://canva-pro-69848a87bb3e.herokuapp.com/copyrights`)
      .then((res) => res.json())
